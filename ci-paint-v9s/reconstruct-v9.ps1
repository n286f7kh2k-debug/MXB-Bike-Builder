...
Copy-Item 'ci-paint-v9s/OfficialMxBikesPreviewModelService.fixed.cs' (Join-Path $moduleRoot 'Services\OfficialMxBikesPreviewModelService.cs') -Force
Copy-Item 'ci-paint-v9s/OfficialMxBikesToolchainService.fixed.cs' (Join-Path $moduleRoot 'Services\OfficialMxBikesToolchainService.cs') -Force
